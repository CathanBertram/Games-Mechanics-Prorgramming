...
#include "ShootingSystemPlayerController.generated.h"

/**
 * 
 */
UCLASS()
class SHOOTINGSYSTEM_API AShootingSystemPlayerController : public APlayerController, public IInitable
{
	GENERATED_BODY()

	AShootingSystemPlayerController();
